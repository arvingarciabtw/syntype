...
export const KEYBOARD_LAYOUTS: Record<string, KeyData[][]> = {
  qwerty: [
    ...
    [
      { display: "Shift", value: "ShiftLeft", finger: 0, width: "wide" },
      ...
      { display: "/", displayShift: "?", value: "/", finger: 0 },
      { display: "Shift", value: "ShiftRight", finger: 0, width: "extra-wide" },
    ],
    [
      { display: "Ctrl", value: "ControlLeft", finger: 0, grow: true },
      { display: "Alt", value: "AltLeft", finger: 0, grow: true },
      { display: "Space", value: " ", finger: 4, width: "spacebar" },
      { display: "Alt", value: "AltRight", finger: 0, grow: true },
      { display: "Ctrl", value: "ControlRight", finger: 0, grow: true },
    ],
  ],
  dvorak: [
    [
